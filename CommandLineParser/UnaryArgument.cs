...
namespace CmdParse
{
	public class UnaryArgument : AbstractArgument
	{
		...
		public UnaryArgument(OptionalSettings optionalSettings, string name, string? shortName, int? freeIndex, Arity arity, Type type, Func<string, ErrorOr<object?>> parser) :
			base(optionalSettings, name, shortName, freeIndex, arity, type)
		{
			Parser = parser;
		}
